...
class RailGun(Rail):
    ...
    def fire(self, method: Literal["GET", "POST"], url: str) -> RESPDATATYPE:
    ...
    def reward(
        ...
        url: str,
        filepath: str,
        reader: Callable[[str], RESPDATATYPE],
        writer: Callable[[str, RESPDATATYPE], None],
    ) -> RESPDATATYPE:
        if os.path.exists(filepath) is True:
            return reader(filepath)
        resp_data = self.fire(method, url)
        writer(filepath, resp_data)
        return resp_data
